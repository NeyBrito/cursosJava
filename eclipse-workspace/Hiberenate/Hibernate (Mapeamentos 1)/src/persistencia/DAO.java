...
public class DAO {
	...
	/**
	 * Persiste uma entidade de qualquer tipo esperado no repositório.
	 * @param <T> um dos tipos mapeados para persistencia.
	 * @param objeto entidade a ser gravada no repositório.
	 */
